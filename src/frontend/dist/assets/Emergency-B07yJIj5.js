import { c as createLucideIcon, a as clsx, R as React2, n as getDefaultExportFromCjs, r as reactExports, k as useActor, g as ue, j as jsxRuntimeExports, A as Activity, Z as Zap, d as cn, S as Skeleton, h as Siren, B as Button, m as createActor } from "./index-Cjz6nUaB.js";
...
import { F as FALLBACK_SEGMENTS, b as getEmergencyAlerts, g as getSegments, d as acknowledgeEmergency, e as createLocalEmergencyAlert, t as triggerEmergencySimulation, C as CircleCheck } from "./trafficApi-j32R7f3i.js";
import { C as Clock } from "./clock-CMKEL1lg.js";
import { S as ShieldCheck } from "./shield-check-B8Gsh8EM.js";
...
function Emergency() {
  ...
  const fetchAlerts = reactExports.useCallback(async () => {
    ...
    try {
      ...
      prevAlertIds.current = /* @__PURE__ */ new Set([
  ...
  const handleTrigger = reactExports.useCallback(async () => {
    ...
    ue.success(`🚨 Emergency triggered: ${vehicleType}`, {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: segments.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    SelectItem,
                    {
                      value: s.id,
