import { c as createLucideIcon, i as useActor, u as useSimulationStore, r as reactExports, j as jsxRuntimeExports, N as Navigation, B as Button, k as RefreshCw, T as TriangleAlert, S as Skeleton, b as cn, h as Badge, l as createActor } from "./index-CKUeRL-6.js";
...
import { g as getRoutes, a as getSegments, c as computeOptimalRoute, C as CircleCheck } from "./trafficApi-CXc-JXmD.js";
import { L as LoaderCircle, C as ChevronRight } from "./loader-circle-De0SGvIW.js";
import { M as MapPin } from "./map-pin-DDftYN2Q.js";
import { C as Clock } from "./clock-CohmnKk-.js";
import "./index-Cr0KaFpS.js";
import "./chevron-up-DwSqudtc.js";
/**
...
const DISTRICTS = ["Downtown", "Midtown", "Uptown", "Suburbs"];
...
function Routing() {
  ...
  reactExports.useEffect(() => {
    ...
    if (!from || !to) return;
    computeOptimalRoute(actor, from, to).then((r) => updateComputedRoute(r)).catch(() => {
    });
