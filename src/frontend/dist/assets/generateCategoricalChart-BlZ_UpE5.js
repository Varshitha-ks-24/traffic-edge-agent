import { j as jsxRuntimeExports, a as cn, v as commonjsGlobal, s as getDefaultExportFromCjs, r as reactExports, f as clsx, R as React2, w as invariant } from "./index-B2saiLCY.js";
const STATUS_CONFIG = {
  // TrafficLevel
  High: {
...
function StatusBadge({ status, label, className }) {
  const config2 = STATUS_CONFIG[status] ?? FALLBACK;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("h-1.5 w-1.5 rounded-full", config2.dot) }),
        displayLabel
      ]
    }
  );
...
export {
  ...
  getTicksOfAxis as Y,
  getAngledRectangleWidth as Z,
  _baseExtremum as _,
  filterProps as a,
  shallowEqual as a0,
  useXAxisOrThrow as a1,
  useYAxisOrThrow as a2,
  Curve as b,
  interpolateNumber$2 as c,
  isEqual$1 as d,
  isNil$1 as e,
  findAllByType as f,
  LabelList as g,
